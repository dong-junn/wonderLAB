...
def page():
    ...
    st.write("1단계 입력: ", st.session_state.stp_1)
    st.write("2단계 입력: ", st.session_state.stp_2)
    st.write("3단계 입력: ", st.session_state.stp_3)
    ...
    # Initialize session state variables for further steps in STEP2
    ...
    st.write("1단계 입력: ", st.session_state.step_1_selection)
    st.write("2단계 입력: ", st.session_state.step3)
    st.write("3단계 입력: ", st.session_state.step4)
